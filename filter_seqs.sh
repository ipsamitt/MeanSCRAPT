...
/usr/bin/time -v python3 /fs/cbcb-scratch/imittra/long-read-data/find_threshold_seqs.py -f /fs/cbcb-scratch/imittra/long-read-data/all_data.fastq -t 16 -c 2.35 -k 5

seqkit grep --pattern-file Kept_IDS.txt all_data.fastq > filtered_seqs.fastq       
